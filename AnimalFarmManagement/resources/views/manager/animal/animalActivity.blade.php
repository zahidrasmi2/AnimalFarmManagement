                                    ...
                                    <div id="accordion">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                                <div class="card-body">
                                                    @csrf
                                                    {!! Form::open(['route' => 'manager.animal.searchActivity', 'method' => 'get'])!!}
                                                    <div class="grid-container">
                                                        ...
                                                        <div class="grid-item">
                                                            Last Check After: <br>
                                                            <input type="date" name="date_after" id="date_after"><br><br>

                                                            Last Check Before: <br>
                                                            <input type="date" name="date_before" id="date_before"><br>
                                                        </div>
                                                        ...
                                                        <div class="grid-item">
                                                            ...
                                                            <br><a class="greeny" href="{{ route('manager.animal.activityDownload') }}" class="btn btn-success" title="Download as excel">Export to Excel</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div style="text-align: center;">
                                                        <a href="{{ route('manager.animal.historyAnimal', [$aniH->animalID]) }}">
                                                            {{ $aniH->tagNumber }}
                                                        </a>
                                                    </div>
                                                </td>
