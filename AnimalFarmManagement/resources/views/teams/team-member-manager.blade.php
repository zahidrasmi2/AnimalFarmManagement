<div>
    ...
    <div class="mt-10 sm:mt-0">
        <x-jet-form-section submit="addTeamMember">
            ...
            <x-slot name="description">
                {{ __('Add a new staff member to your company, allowing them to collaborate with you.') }}
            </x-slot>
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 lg:col-span-4">
                    ...
                    <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                        ...
                        <button type="button" class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue {{ $index > 0 ? 'border-t border-gray-200 rounded-t-none' : '' }} {{ ! $loop->last ? 'rounded-b-none' : '' }}" wire:click="$set('addTeamMemberForm.role', '{{ $role->key }}')">
    ...
    <x-jet-dialog-modal wire:model="currentlyManagingRole">
        ...
        <x-slot name="content">
            <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                @foreach ($this->roles as $index => $role)
                <button type="button" class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue {{ $index > 0 ? 'border-t border-gray-200 rounded-t-none' : '' }} {{ ! $loop->last ? 'rounded-b-none' : '' }}" wire:click="$set('currentRole', '{{ $role->key }}')">
